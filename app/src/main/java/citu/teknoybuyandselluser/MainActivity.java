    ...
    public void openDialog(View view) {
        if (chkAgreeTerms.isChecked()) {
            ...
            termsAndConditions.setMessage("USER" + "\n" +
                            ...
                            "In case of unreturned rented items on the set expiration date, penalties will be fined to the renters. The penalty will be 10% of the total payment per day. 10% of the penalty will go to the TBS developers and 90% will go to the user. If the user cannot " +
