...
public class DonatedItemFragment extends Fragment {
    ...
    public static DonatedItemFragment newInstance(String itemName, String description, String picture, int stars_required) {
        DonatedItemFragment fragment = new DonatedItemFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_donated_item, container, false);
