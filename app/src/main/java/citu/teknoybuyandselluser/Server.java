...
public class Server {
    ...
    private static final String URL_REGISTER = "http://192.168.43.121:8000/api/register";
    private static final String URL_LOGIN = "http://192.168.43.121:8000/api/login";
    private static final String URL_CHANGE_PASSWORD = "http://192.168.43.121:8000/api/change_password";
